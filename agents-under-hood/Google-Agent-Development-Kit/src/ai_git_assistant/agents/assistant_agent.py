...
def create_git_assistant_agent() -> Agent:
    ...
    *   **Результат:**
    ...
    Твой ответ должен содержать ИСКЛЮЧИТЕЛЬНО сгенерированное сообщение коммита в виде простого текста, без каких-либо объяснений, заголовков, комментариев или markdown-разметки типа, строго на Русском языке. \`\`\`.
    </instruction>
    """
    )
