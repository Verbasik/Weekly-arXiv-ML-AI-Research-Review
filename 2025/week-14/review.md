...
![Мел-спектрограмма](https://raw.githubusercontent.com/Verbasik/Weekly-arXiv-ML-AI-Research-Review/refs/heads/develop/2025/week-14/assets/Figure_3.png)
...
#### **TMRoPE: Позиционное кодирование для мультимодальных данных**

Time-aligned Multimodal RoPE (TMRoPE) представляет собой фундаментальное инновационное решение, разработанное для преодоления одной из наиболее сложных задач в области мультимодального искусственного интеллекта: синхронизации временных данных из различных источников. При одновременной обработке видео и аудио модель должна понимать, как визуальные события соотносятся с соответствующими звуками или речью.

Для синхронизации временных меток видеовходов с аудио разработчики модели организуют аудио и видео последовательно в перемежающемся порядке (interleaved manner), применяя новый подход к позиционному кодированию TMRoPE. Данный механизм позволяет модели эффективно интегрировать информацию из разных модальностей, сохраняя при этом временную согласованность и понимая временные взаимосвязи между видео и аудиоконтентом.

TMRoPE является расширением метода RoPE (Rotary Position Embedding), адаптированным для координации различных модальностей во временной области. Эта техника позиционного кодирования обеспечивает лучшую синхронизацию видеовходов с аудио для когерентной генерации контента, что особенно важно при работе с динамическими мультимодальными данными. Применение TMRoPE существенно повышает способность модели к согласованному восприятию различных модальностей и генерации соответствующих ответов.
