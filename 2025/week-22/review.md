...
$$\{p_i\}_{i=1}^m \sim p_{\theta}(x, \{y_i\}_{i=1}^n), \qquad R = C \sim r_{\theta}\big(x, \{y_i\}_{i=1}^n, \{p_i\}_{i=1}^m\big),$$
...
![SPCT](https://raw.githubusercontent.com/Verbasik/Weekly-arXiv-ML-AI-Research-Review/refs/heads/develop/2025/week-22/assets/Figure_03.png)
...
![Naive voting (голосование)](https://raw.githubusercontent.com/Verbasik/Weekly-arXiv-ML-AI-Research-Review/refs/heads/develop/2025/week-22/assets/Figure_03.1.png)
