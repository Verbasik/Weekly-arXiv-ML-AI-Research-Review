...
### 7. **Ограничения**
- **Высокая размерность входа**: Для **$l=256$** и **$d_{\text{model}}=1024$** вход MLP будет **262,144**-мерным, что требует больших вычислительных ресурсов.
- **Риск потери деталей**: Агрегация в один вектор может игнорировать тонкие зависимости между токенами.
