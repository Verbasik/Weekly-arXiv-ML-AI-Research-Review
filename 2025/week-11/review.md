...
Документ "review.md" посвящен углубленному изучению метода дистилляции знаний (Knowledge Distillation) и недавних исследований в области законов масштабирования для этого метода, в частности, работы Apple и Оксфордского университета, основанной на исследовании DeepSeek. Автор отмечает, что вводные статьи по дистилляции (упоминаются две статьи инженера из Яндекса) являются хорошим началом, но данный обзор направлен на более глубокое понимание математических основ, практической реализации и нюансов исследований в этой области.
...
Автор переходит к обсуждению работы исследователей из Apple и Оксфордского университета, посвященной закону масштабирования дистилляции, основанной на исследовании DeepSeek.
...
Подчеркивается огромное значение исследования Apple и Оксфордского университета для практического применения больших языковых моделей, особенно в контексте растущих затрат на вычисления и экологического следа ИИ. Разработанный закон масштабирования позволяет принимать обоснованные решения об использовании дистилляции и выборе параметров, что потенциально может экономить значительные ресурсы и делать передовые ИИ-технологии более доступными. Исследование открывает путь к более систематическому подходу в области дистилляции знаний.
...
- Увеличение затрат: использование более крупной модели учителя повлечет за собой более высокие затраты из-за необходимости вычисления логистики модели учителя. Это означает, что более крупная модель учителя не только более затратна в обучении, но и потребляет больше вычислительных ресурсов при использовании для дистилляции.

На рисунке ниже показано изменение потери перекрестной энтропии модели студента при различных бюджетах данных дистилляции. Результаты показывают, что оптимальная потеря учителя (представленная красной линией) уменьшается по степенному закону с увеличением численности учащихся до тех пор, пока потеря ученика не сравняется с оптимальной потерей учителя. Это подтверждает, что оптимальная численность учителя почти всегда линейно пропорциональна численности учащихся.
...
Как видно на другом рисунке ниже, по мере увеличения объема данных дистилляции, перекрестная энтропия оптимальной модели учителя постепенно уменьшается, но скорость уменьшения карзамедляется с увеличением . Таким образом, можно сделать вывод, что: когда вычислительные ресурсы ограничены, выбор меньшей модели учителя может снизить затраты на вывод, при этом обеспечивая эффективные сигналы обучения для модели ученика.
