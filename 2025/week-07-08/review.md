...
Далее рассмотрим новую функцию Multi-Token Prediction (MTP). Идея MTP заключается в прогнозировании более одного токена в каждой позиции. В текущей модели это два токена — текущий и следующий. Теоретически это усиливает обучающий сигнал и может повысить эффективность данных. Это также может помочь модели лучше подготовиться к прогнозированию будущих токенов.
...
[8] Fast Transformer Decoding: One Write-Head is All You Need (2019) arXiv:1911.02150 (https://arxiv.org/abs/1911.02150)

[9] GQA: Training Generalized Multi-Query Transformer Models from Multi-Head Checkpoints (2023) arXiv:2305.13245 (https://arxiv.org/abs/2305.13245)

[10] Damai Dai, Chengqi Deng, Chenggang Zhao, R.X. Xu, Huazuo Gao, Deli Chen, Jiashi Li, Wangding Zeng, Xingkai Yu, Y. Wu, Zhenda Xie, Y.K. Li, Panpan Huang, Fuli Luo, Chong Ruan, Zhifang Sui, Wenfeng Liang (2024) arXiv:2401.06066 (https://arxiv.org/abs/2401.06066)